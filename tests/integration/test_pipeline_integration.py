...
class TestPipelineIntegration:
    ...
    def test_complete_data_processing_pipeline(self):
        ...
        def filter_data(df):
            ...
            df_filtered = df_filtered[
                (df_filtered["price"] > 100) & (df_filtered["price"] < 8000)
            ]
    ...
    def test_model_training_integration(self):
        ...
        training_data["bed_bath_ratio"] = training_data["bedrooms"] / training_data[
            "bathrooms"
        ].replace(0, 1)
        training_data["sqft_x_beds"] = (
            training_data["square_feet"] * training_data["bedrooms"]
        )
        ...
        )  # Prices should be positive  # noqa: E501

        # Check if we have enough test samples for R² calculation
        if len(y_test) >= 2:
            model.score(X_test, y_test)
            # With random data, the model might not perform well, but we should have predictions  # noqa: E501
    ...
    def test_kinesis_event_processing_integration(self):
        ...
        kinesis_event = {"Records": [{"kinesis": {"data": encoded_data}}]}
    ...
    def test_data_validation_integration(self):
        ...
        def filter_data(df):
            ...
            df_filtered = df_filtered[
                (df_filtered["bedrooms"] > 0) & (df_filtered["bathrooms"] > 0)
            ]
            return df_filtered
    ...
    def test_error_handling_integration(self):
        ...
        malformed_event = {"Records": [{"kinesis": {"data": "invalid-base64-data"}}]}
        ...
        def mock_lambda_handler_with_errors(event, context):
            ...
            for record in event["Records"]:
                try:
                    ...
                    prediction = 2000
                    predictions.append(
                        {"features": event_data, "prediction": prediction}
                    )
    ...
    def test_performance_integration(self):
        ...
        filtered_data = filtered_data[
            (filtered_data["price"] > 100) & (filtered_data["price"] < 8000)
        ]  # noqa: E501
        ...
        # Verify performance is reasonable (should complete in under 1 second for 1000 records)  # noqa: E501
        assert processing_time < 1.0  # nosec B101
        ...
        assert prediction_time < 1.0  # nosec B101
